...
public class TransactionName : ValueObject
{
    ...
    public static implicit operator string(TransactionName value) => value.Value;
    public static implicit operator TransactionName(string value) => new TransactionName(value);
